...
export default function ImmunoWar(){
  const [chr,setChr]=useState(()=>{try{const s=localStorage.getItem("immunowar_player");return s?JSON.parse(s):{gender:"female",age:"young",name:""};}catch{return{gender:"female",age:"young",name:"";};}});
