...
async function loadScores(){try{const r=localStorage.getItem(LB_KEY);return r?JSON.parse(r):[];}catch(e){return[];}}
async function saveScore(e){try{const s=await loadScores();s.push(e);s.sort((a,b)=>b.score-a.score);const t=s.slice(0,10);localStorage.setItem(LB_KEY,JSON.stringify(t));return t;}catch(e){return[];}}
